...
class BinaryCodec_RCF {
  ...
  */
  void initKey(const unsigned short pnPassData[16],
  ...
  */
  bool verifyKey(const unsigned char pnVerifier[16],
  ...
  */
  bool decode(unsigned char* pnDestData, const unsigned char* pnSrcData,
              size_t nBytes);
