...
void RC4Decryptor::Decrypt(char* data, const size_t size,
...
XORDecryptor::XORDecryptor(int type, unsigned short key, unsigned short hash,
...
void XORDecryptor::Decrypt(char* data, const size_t size,
                           const unsigned long stream_pos,
                           const size_t block_size) {
  crypt->Decrypt(data, size, stream_pos, block_size);
}
